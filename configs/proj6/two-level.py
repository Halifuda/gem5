...
parser = OptionParser()
parser.add_option('--bp', type = "string", default = "default?")
...
if options.bp == "ban":
    root.system.cpu.branchPred = BanBP()
elif options.bp == "local":
    root.system.cpu.branchPred = Local_BP()
elif options.bp == "bimode":
    root.system.cpu.branchPred = BiM_BP()
    root.system.cpu.branchPred.globalPredictorSize = 2048
elif options.bp == "p8k":
    root.system.cpu.branchPred = P8k_BP()
elif options.bp == "p64k":
    root.system.cpu.branchPred = P64k_BP()
elif options.bp == "tour":
    root.system.cpu.branchPred = T_BP()
elif options.bp == "simple":
    root.system.cpu.branchPred = MySimpleBP()
elif options.bp == "myp":
    root.system.cpu.branchPred = MyP_BP()
